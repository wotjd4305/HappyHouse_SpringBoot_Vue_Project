...
public class BoardController {
	...
	public ResponseEntity<List<Board>> selectBoardBySearchWord(@RequestParam String searchword) {
		logger.debug("selectBoardBySearchWord - 호출");
		return new ResponseEntity<List<Board>>(boardService.selectBoardBySearchWord(searchword), HttpStatus.OK);
	}
